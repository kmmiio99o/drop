    ...
    if (!hasConfirmed) {
      const confirmed = await new Promise<boolean>(resolve => {
        showConfirmationAlert({
          title: "WARNING!!!!",
          content:
            "Enabling token utilities has it's own risks.\n**Do not share your token with anyone, doing so will give unrestricted access to your account to them.**\nDrop dev team and contributors do not bear any responsibility for any issues faced when using the plugin, including security risks and possible account termination.\n**Use at your own risk**\n",
